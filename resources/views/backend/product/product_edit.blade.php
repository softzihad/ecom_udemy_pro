...
<!-- ///////////////// Start Multiple Image Update Area ///////// -->
 ...
 <section class="content"><!-- Start 2nd content section -->
 	<div class="row">
		<div class="col-md-12">
 ...
 </section><!-- End 2nd content section -->
    				...
    				<input type="hidden" name="old_img" value="{{ $product->product_thambnail }}">
						...
						<div class="row row-sm">
							<div class="col-md-3">
								...
								<div class="card">
								  <img src="{{ asset($product->product_thambnail) }}" class="card-img-top" style="height: 180px; width: 280px;">
								  <div class="card-body">
								    <p class="card-text"> 
								    	<div class="form-group">
								    		<label class="form-control-label">Change Image <span class="tx-danger">*</span></label>
