    ...
    <div class='row'>
              ...
              <div class="sidebar-widget-body">
                <div class="accordion">
                  ...
                  <div class="accordion-group">
                   ...
                   @php
                   $categoryf = App\Models\Category::find(1);
                   @endphp
                    <!-- /.accordion-heading -->
                    <div class="accordion-body collapse" id="collapse{{ $category->id }}" style="height: 0px;">
                      <div class="accordion-inner">
                        @foreach($category->subcategories()->orderBy('subcategory_name_en', 'ASC')->get() as $subcategory)
                        <ul>
                          <li>
      ...
      <div class='col-md-9'> 
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            <div class="image"> <img src="{{ asset('frontend-template/assets/images/banners/cat-banner-1.jpg') }}" alt="" class="img-responsive"> </div>
