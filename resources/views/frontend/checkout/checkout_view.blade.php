							  ...
							  <div class="panel-body">
									<div class="row">		
										...
										<div class="col-md-6 col-sm-6 already-registered-login">
											...
											<div class="form-group">
												<h5><b>Upazila Select</b>  <span class="text-danger">*</span></h5>
												<div class="controls">
						...
						<div class="panel-group">
							<div class="panel panel-default">
							  ...
							  <div class="row">
						        ...
						        <img src="{{ asset('frontend-template/assets/images/payments/4.png') }}">		    		
						    	</div> <!-- end col md 4 -->

						    	<div class="col-md-4">
						    		<label for="">Card</label> 		
				      			<input type="radio" name="payment_method" value="card">	
										<img src="{{ asset('frontend-template/assets/images/payments/3.png') }}">    		
						    	</div> <!-- end col md 4 -->
