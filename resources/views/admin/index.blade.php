		...
		<div class="col-xl-3 col-6">
			<div class="box overflow-hidden pull-up">
				<div class="box-body">							
					...
					<div>
						<p class="text-mute mt-20 mb-0 font-size-16">New Customers <span class="text-danger">{{ Auth::user()->name }}</span></p>
							...
							<tbody>
									...
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" style="background-image: url({{ asset('backend-admin/images/gallery/creative/img-1.jpg') }}"></div>
											</div>
								...
								<tr>										
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" style="background-image: url({{ asset('backend-admin/images/gallery/creative/img-2.jpg') }}"></div>
											</div>
								...
								<tr>										
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" style="background-image: url({{ asset('backend-admin/images/gallery/creative/img-3.jpg') }}"></div>
											</div>
								...
								<tr>										
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" style="background-image: url({{ asset('backend-admin/images/gallery/creative/img-4.jpg') }}"></div>
											</div>
								...
								<tr>										
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" style="background-image: url({{ asset('backend-admin/images/gallery/creative/img-5.jpg') }}"></div>
											</div>
