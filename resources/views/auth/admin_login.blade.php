...
<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="name" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
  ...
  <script src="{{ asset('backend-admin/assets/icons/feather-icons/feather.min.js') }}"></script>	
